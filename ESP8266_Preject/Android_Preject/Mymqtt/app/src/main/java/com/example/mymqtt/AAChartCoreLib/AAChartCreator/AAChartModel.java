...
import com.example.mymqtt.AAChartCoreLib.AAChartEnum.AAChartStackingType;
...
import com.example.mymqtt.AAChartCoreLib.AAChartEnum.AAChartZoomType;
import com.example.mymqtt.AAChartCoreLib.AAOptionsModel.AAScrollablePlotArea;
...
public class AAChartModel {
    ...
    public String axesTextColor = "#fff4ff";         //x 轴和 y 轴文字颜色
    ...
    public AAChartModel() {
        ...
        titleFontColor        = "#FF00BCD4";//标题字体颜色为黑色
        titleFontWeight       = "regular";//常规字体
        titleFontSize         = 11f;
        subtitleFontColor     = "#FF00BCD4";//副标题字体颜色为黑色
        subtitleFontWeight    = "regular";//常规字体
        subtitleFontSize      = 9f;
        dataLabelsFontColor   = "#FF00BCD4";//数据标签默认颜色为黑色
